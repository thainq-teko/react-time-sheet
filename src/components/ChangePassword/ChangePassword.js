  ...
  return (
    <div>
      <div>
        ...
        <input type="text" name="username" id="username" autoFocus autoComplete="off" value={form.username} onChange={updateField} />
      </div>

      <div>
        <label htmlFor="">Password</label>
        <input type="password" name="password" id="password" autoComplete="off" value={form.password} onChange={updateField} />
        <br />
      </div>

      <div>
        <label htmlFor="">New password</label>
        <input type="password" name="newpassword" id="newpassword" autoComplete="off" value={form.newpassword} onChange={updateField} />
        <br />
      </div>
      ...
      <div>
        <button onClick={resetPass} id="change-passw-btn">Change Password</button>
